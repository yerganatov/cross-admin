...
import changePartners from "./changeParners";
        ...
        return (
            <BrowserRouter>
                <div>
                    ...
                    <PrivateRoute path="/changeContacts" component={changeContacts} />
                    ...
                    <PrivateRoute path="/changeParteners/:id" component={changePartners} />
